...
export WIIUBIN	:=	$(LIB)/libfswrapper.a
...
export INCLUDEDIR := $(PORTLIBS)/include/libfswrapper
...
install:
	@cp $(BUILD)/lib/libfswrapper.a $(PORTLIBS)/lib
	@mkdir -p $(INCLUDEDIR)/fswrapper/
	@cp include/*.h $(INCLUDEDIR)/fswrapper/
